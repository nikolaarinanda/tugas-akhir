...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{Analisis Sentimen Komentar Cyberbullying pada Sosial Media TikTok Menggunakan Arsitektur TextCNN} % Judul Tugas Akhir dalam Bahasa Indonesia	
    % DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    \titleEN{Sentiment Analysis of Cyberbullying Comments on TikTok Social Media Using TextCNN Architecture}      % Judul Tugas Akhir dalam Bahasa Inggris
    
    % Informasi Mahasiswa
    \author{Nikola Arinanda}		% Nama Mahasiswa
	\nim{121140202}			% NIM Mahasiswa
	...
	\dosbingB%
		...
		{NRK. 19970817 2024 2294}				% NIP Dosen Pembimbing 2
		
	%Informasi Dosen Penguji
	\pengujiA%
		{Imam Ekowicaksono, S.Si., M.Si.}%	% Nama Dosen Penguji 1
		{NIP. 19890517 201903 1 013}				% NIP Dosen Penguji 1
	\pengujiB%
		{Winda Yulita, M.Cs.}%	% Nama Dosen Penguji 2
		{NIP. 19930727 2022 03 2 022}				% NIP Dosen Penguji 2
